...
@section('title', 'Tambah Kamar - Sewa An Kost')

@section('content')
<div class="container">
    <div style="margin-bottom: 20px;">
        <a href="{{ route('kamar.index') }}" style="color: white; text-decoration: none; font-size: 14px; font-weight: 600; opacity: 0.9;">
            ← Kembali ke Daftar Kamar
        </a>
    </div>

    <div style="margin-bottom: 20px;">
        <h1 style="font-size: 24px; color: white; margin-bottom: 5px;">➕ Tambah Kamar Baru</h1>
        <p style="color: rgba(255,255,255,0.9); font-size: 14px;">Isi form di bawah untuk menambahkan kamar</p>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" id="nomor_kamar" name="nomor_kamar" value="{{ old('nomor_kamar') }}" required placeholder="Contoh: A-01">
                </div>
            </div>
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="lantai" name="lantai" value="{{ old('lantai') }}" min="0" placeholder="0">
                </div>
            </div>
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="harga_per_bulan" name="harga_per_bulan" value="{{ old('harga_per_bulan') }}" required min="0" placeholder="1000000">
                </div>
            </div>
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="text" id="ukuran_kamar" name="ukuran_kamar" value="{{ old('ukuran_kamar') }}" placeholder="Contoh: 3x4 meter">
                </div>
            </div>
            ...
            <div style="grid-column: span 2;">
                <div class="form-group">
                    ...
                    <textarea id="fasilitas_kamar" name="fasilitas_kamar" placeholder="Contoh: AC, Kamar mandi dalam, Kasur, Lemari">{{ old('fasilitas_kamar') }}</textarea>
                </div>
            </div>
