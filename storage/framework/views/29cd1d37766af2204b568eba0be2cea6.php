<?php $__env->startSection('title', 'Home - Sewa An Kost'); ?>
    ...
    <div style="background: white; border-radius: 12px; padding: 60px 40px; text-align: center; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                <a href="<?php echo e(route('kost-public.index')); ?>" class="btn" style="min-width: 150px;">
                    🔍 Cari Kost
                </a>
                <a href="<?php echo e(route('login')); ?>" class="btn" style="background: white; color: #970747; border: 2px solid #970747; min-width: 150px;">
                    🔐 Login
                </a>
                <a href="<?php echo e(route('register')); ?>" class="btn" style="background: white; color: #970747; border: 2px solid #970747; min-width: 150px;">
                    📝 Register
                </a>
            </div>
        ...
        <?php else: ?>
            <div style="margin-top: 30px;">
                <a href="<?php echo e(auth()->user()->role === 'pemilik' ? route('dashboard.pemilik') : route('dashboard.penyewa')); ?>" class="btn" style="min-width: 200px;">
                    📊 Buka Dashboard
                </a>
            </div>
        <?php endif; ?>
