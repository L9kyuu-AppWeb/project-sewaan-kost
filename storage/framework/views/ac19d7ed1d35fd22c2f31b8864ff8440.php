<?php $__env->startSection('title', $kost->nama_kost . ' - Detail Kost'); ?>

<?php $__env->startSection('content'); ?>
<div style="max-width: 1200px; margin: 0 auto; padding: 20px;">
    <!-- Back Button -->
    <div style="margin-bottom: 20px;">
        <a href="<?php echo e(route('kost-public.index')); ?>" style="color: white; text-decoration: none; font-size: 14px; font-weight: 600; opacity: 0.9;">
    ...
    <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1); margin-bottom: 30px;">
        ...
        <div style="padding: 30px;">
            <h1 style="font-size: 28px; color: #222; margin-bottom: 10px; font-weight: 700;"><?php echo e($kost->nama_kost); ?></h1>
            <p style="font-size: 15px; color: #666; margin-bottom: 20px;">📍 <?php echo e($kost->alamat); ?></p>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 25px;">
                <div style="background: #f8f9fa; padding: 20px; border-radius: 10px;">
                    ...
                    <p style="font-size: 16px; color: #222; font-weight: 600;"><?php echo e($kost->pemilik->nama_lengkap); ?></p>
                </div>
                <div style="background: #f8f9fa; padding: 20px; border-radius: 10px;">
                    <p style="font-size: 13px; color: #666; margin-bottom: 5px;">📞 Kontak</p>
                    <p style="font-size: 16px; color: #222; font-weight: 600;"><?php echo e($kost->pemilik->no_hp); ?></p>
                </div>
                <div style="background: #f8f9fa; padding: 20px; border-radius: 10px;">
                    <p style="font-size: 13px; color: #666; margin-bottom: 5px;">🛏️ Kamar Tersedia</p>
                    <p style="font-size: 16px; color: #970747; font-weight: 700;"><?php echo e($kost->rooms->count()); ?> Kamar</p>
                </div>
            </div>

            <!-- Description -->
            <?php if($kost->deskripsi): ?>
                <div style="margin-bottom: 25px;">
                    <h3 style="font-size: 18px; color: #222; margin-bottom: 12px; font-weight: 700;">📋 Deskripsi</h3>
                    <p style="color: #666; line-height: 1.8;"><?php echo e($kost->deskripsi); ?></p>
                </div>
            <?php endif; ?>
            ...
            <?php if($kost->fasilitas_umum): ?>
                <div style="margin-bottom: 25px;">
                    ...
                    <p style="color: #666; line-height: 1.8;"><?php echo e($kost->fasilitas_umum); ?></p>
                </div>
            <?php endif; ?>
            ...
            <?php if($kost->peraturan): ?>
                <div style="margin-bottom: 25px;">
                    ...
                    <p style="color: #666; line-height: 1.8;"><?php echo e($kost->peraturan); ?></p>
                </div>
            <?php endif; ?>

            <!-- Location -->
            <?php if($kost->latitude && $kost->longitude): ?>
                <div style="margin-bottom: 25px;">
                    <h3 style="font-size: 18px; color: #222; margin-bottom: 12px; font-weight: 700;">📍 Lokasi</h3>
                    <p style="color: #666; margin-bottom: 15px;">
                        Latitude: <?php echo e($kost->latitude); ?> | Longitude: <?php echo e($kost->longitude); ?>

                    </p>
                    <a href="https://www.google.com/maps?q=<?php echo e($kost->latitude); ?>,<?php echo e($kost->longitude); ?>" 
                       target="_blank"
    ...
    <?php if($kost->rooms->count() > 0): ?>
        <div id="daftar-kamar" style="background: white; border-radius: 12px; padding: 25px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
            <h2 style="font-size: 22px; color: #222; margin-bottom: 20px; font-weight: 700;">
                🛏️ Kamar Tersedia (<?php echo e($kost->rooms->count()); ?>)
            </h2>
                    ...
                    <div style="background: #f8f9fa; border-radius: 10px; overflow: hidden; border: 1px solid #eee;">
                        <div style="height: 150px; background: linear-gradient(135deg, #970747 0%, #c41e6a 100%); display: flex; align-items: center; justify-content: center;">
                            <?php if($room->foto_kamar): ?>
                                <img src="<?php echo e(asset('storage/' . $room->foto_kamar)); ?>" alt="<?php echo e($room->nomor_kamar); ?>" 
                                     style="width: 100%; height: 100%; object-fit: cover;">
                            <?php else: ?>
                        ...
                        <div style="padding: 15px;">
                            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 8px;">
                                <h4 style="font-size: 15px; color: #222; margin: 0; font-weight: 700;">Kamar <?php echo e($room->nomor_kamar); ?></h4>
                                <?php if($room->lantai): ?>
                                    <span style="font-size: 10px; color: #666; background: #e0e0e0; padding: 2px 6px; border-radius: 8px;">
                                        Lt. <?php echo e($room->lantai); ?>

                                    </span>
                                <?php endif; ?>
                            </div>

                            <?php if($room->ukuran_kamar): ?>
                                <p style="font-size: 12px; color: #888; margin-bottom: 8px;">📐 <?php echo e($room->ukuran_kamar); ?></p>
                            <?php endif; ?>

                            <?php if($room->fasilitas_kamar): ?>
                                <p style="font-size: 11px; color: #888; margin-bottom: 12px; line-height: 1.4;">
                                    🏷️ <?php echo e(Str::limit($room->fasilitas_kamar, 40)); ?>

                                </p>
                            <?php endif; ?>

                            <p style="font-size: 18px; color: #970747; font-weight: 700; margin: 10px 0;">
                                Rp <?php echo e(number_format($room->harga_per_bulan, 0, ',', '.')); ?>

                                <span style="font-size: 12px; color: #666; font-weight: 400;">/bulan</span>
                            </p>

                            <div style="display: flex; gap: 6px; margin-top: 12px;">
                                <a href="https://wa.me/<?php echo e($kost->pemilik->no_hp); ?>?text=Halo, saya tertarik dengan Kamar <?php echo e($room->nomor_kamar); ?> di <?php echo e($kost->nama_kost); ?>" 
                                   target="_blank"
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(auth()->user()->role === 'penyewa'): ?>
                                        <a href="<?php echo e(route('pesan.create', $room->id_kamar)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\laravel-sewaan-kost\resources\views/kost-public/show.blade.php ENDPATH**/ ?>